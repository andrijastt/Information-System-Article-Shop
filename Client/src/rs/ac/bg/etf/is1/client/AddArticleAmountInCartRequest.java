 ...
 * @author stoja
 */
public class AddArticleAmountInCartRequest extends Request {

    public AddArticleAmountInCartRequest(Client client, Scanner scanner) {
        super(client, scanner);
    }

    @Override
    public String name() {
        return "Add article amount in cart reqeust";
    }
    ...
    public Response send() {
        ...
        Response response = client.target("http://localhost:8080/Server/article/addArticleAmountInCart")
                .request()
